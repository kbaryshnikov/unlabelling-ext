...
const staticMap: BlockerConfigurationLoaderResult = {
    ...
    replacements: {
        searchText: 'данноесообщениематериалсозданоиилираспространеноиностраннымсредствоммассовойинформациивыполняющимфункциииностранногоагентаиилироссийскимюридическимлицомвыполняющимфункциииностранногоагента',
